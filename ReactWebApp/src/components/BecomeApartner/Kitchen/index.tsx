...
import ChefIconImg from './chef_icon.jpg'
...
const Kitchen = (props) =>{
    ...
    const handleSubmit = () => {
        ...
        if (isValid) {
            ...
            Axios.post("http://localhost:3001/profile/updateToChef", {
                id : profileId,
                firstName : firstName,
                lastName : lastName,
            ...
            handleLinkClick("/becomeapartner/KitchenStart");
        }
    };
                    ...
                    <Row>
                        <Col md={6} sm={12}>
                            ...
                            <div className="text-center">
                                <img src={ChefIconImg} width="100%" alt="chef" />
                            </div>
                            <br />
                            <br />
