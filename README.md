#  Team Members 
 ...
 |Name | email address|
 |-----|-------------|
 |Asim Jasarevic|jasa0008@algonquinlive.com|
 |Jonathan Hotner|hotn0002@algonquinlive.com|
 |Griffenjosep Tanguay|tang0212@algonquinlive.com|
 |Muhammadmohi Qureshi|qure0037@algonquinlive.com|

# Project Descreption
During the pandemic, many households have had issues with members losing jobs or income and need a way to offset the reduction in income. Taza project is a platform that allows members of households to cook from home and sell delicious home-made food and deliver it to the customers. The Platform comprises of multiple interfaces for different users.

# System components

The system comprises of multiple interfaces , each interface is designed for a specific task and operations 

## Interfaces

* ### Administration Interface 
    Will be used to manage all aspects of the other interfaces
* #### Customer Interface 
    Shows all available kitchens and controls a customer's cart and orders
* #### Driver Interface 
    Provides a driver with delivery opportunity and directs them to the delivery location
* #### Kitchen Interface 
    Provies a Kitchen with options to customize their kitchen profile and show available meals for order
# Language and Tools Requirements 
...
* ### Database
    * ### MySQL  
# Hosting platform 
The project will be hosted on Azure App Service 

# Web Aplication Template
## react-spa
...
```json
  "homepage": "https://myusername.github.io/react-web-app",
```
...
To publish it at [https://myusername.github.io/react-web-app](https://myusername.github.io/react-web-app), run:
